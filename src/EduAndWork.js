	...
	return (
		<div className="w-full px-5 md:px-32">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
				<div className=" bg-gray-700 rounded-lg drop-shadow-lg p-10 w-full">
					<h1 className="text-4xl font-bold w-full border-solid border-b-2 border-gray-500 pb-3">Education</h1>
					<div className="text-2xl font-bold text-justify border-solid border-l-4 border-gray-500 mt-3 ml-2 pl-2">
						<p className="text-xl text-gray-300 font-normal">2023 - Present</p>
					...
					<div className="text-2xl font-bold text-left border-solid border-l-4 border-gray-500 mt-3 ml-2 pl-2">
						<p className="text-xl text-gray-300 font-normal">2020 - 2023</p>
						<p>Mardi Yuana High School Depok</p>
						<p className="font-normal text-xl">Natural Science Concentration</p>
					</div>
				</div>
				<div className=" bg-gray-700 rounded-lg drop-shadow-lg p-10 w-full">
					<h1 className="text-4xl font-bold w-full border-solid border-b-2 border-gray-500 pb-3">Work experience</h1>
					<div className="text-2xl font-bold  text-justify border-solid border-l-4 border-gray-500 mt-3 ml-2 pl-2 ">
						<p className="text-xl text-gray-300 font-normal">Oct 2023 - Dec 2023</p>
