		...
		<div className="flex lg:flex-row flex-col items-center h-full">
			<div className="flex flex-col justify-center w-full lg:w-1/2 h-1/2 lg:h-full">
				...
				<h2 className="text-3xl">
					I'm <TypeAnimation sequence={["a Web Developer", 2000, "an AI Orchestrator", 2000, "an App Developer", 2000]} speed={50} wrapper="span" repeat={Infinity} className="text-orange-500" />
				</h2>
			</div>
